...
})({"hzN0s":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "d0cbe9d0d893cac3";
"use strict";
...
},{}],"bZJ7i":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _refs = require("./refs");
var _fetch = require("./fetch");
var _renderModal = require("./renderModal");
var _renderModalDefault = parcelHelpers.interopDefault(_renderModal);
...
let searchId;
(0, _refs.closeModalBtn).addEventListener("click", closeModal);
function openModal() {
    (0, _refs.modal).classList.remove("is-hidden");
...
function closeModal() {
    (0, _refs.modal).classList.add("is-hidden");
    ...
    (0, _refs.containerElem).innerHTML = "";
}
...
function handleClickOnBackdrop(e) {
    if (e.target === (0, _refs.modal)) closeModal();
}
(0, _refs.galleryRef).addEventListener("click", handleFilmClick);
async function handleFilmClick(e) {
    ...
    if (e.target.closest("li")) {
        ...
        searchId = id;
        await (0, _fetch.fetchMovie)(id).then((data)=>(0, _renderModalDefault.default)(data));
        openModal();
    }
}
...
function handleBtnTrailerClick(e) {
    ...
    const id = searchId;
    (0, _fetch.fetchTrailerFilm)(id).then(({ results  })=>{
...
},{"./refs":"jHtzO","./fetch":"fybPx","./renderModal":"ke9rC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ke9rC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _refs = require("./refs");
function renderModal({ title , vote_average , vote_count , popularity , original_title , genres , overview , poster_path  }) {
    //   console.log(genres);
    const ganresMarkup = genres.map((genre)=>{
        return genre.name;
    }).join(", ");
          ...
          <div class="film__content-wrapper">
            ...
            <ul class="film__properties-list">
              ...
              <li class="film__properties-item">
                ...
                <span class="film__popularity-text">${popularity.toFixed(2)}</span>
              </li>
              <li class="film__properties-item">
    ...
    (0, _refs.containerElem).insertAdjacentHTML("afterbegin", markup);
}
exports.default = renderModal;

},{"./refs":"jHtzO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hzN0s","bZJ7i"], "bZJ7i", "parcelRequired76b")

//# sourceMappingURL=index.d893cac3.js.map

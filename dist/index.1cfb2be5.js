...
})({"dxiIb":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "3db4f23f1cfb2be5";
"use strict";
...
},{}],"jHtzO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "galleryRef", ()=>galleryRef);
parcelHelpers.export(exports, "formRef", ()=>formRef);
parcelHelpers.export(exports, "openModalBtn", ()=>openModalBtn);
parcelHelpers.export(exports, "closeModalBtn", ()=>closeModalBtn);
parcelHelpers.export(exports, "modal", ()=>modal);
parcelHelpers.export(exports, "containerElem", ()=>containerElem);
parcelHelpers.export(exports, "addWatchBtn", ()=>addWatchBtn);
parcelHelpers.export(exports, "goTop", ()=>goTop);
parcelHelpers.export(exports, "headerContainer", ()=>headerContainer);
parcelHelpers.export(exports, "footerModal", ()=>footerModal);
parcelHelpers.export(exports, "openTeamModal", ()=>openTeamModal);
parcelHelpers.export(exports, "closeTeamModal", ()=>closeTeamModal);
parcelHelpers.export(exports, "backdrop", ()=>backdrop);
parcelHelpers.export(exports, "addQueueBtn", ()=>addQueueBtn);
parcelHelpers.export(exports, "openModalAuth", ()=>openModalAuth);
parcelHelpers.export(exports, "closeLoginBtn", ()=>closeLoginBtn);
parcelHelpers.export(exports, "closeRegBtn", ()=>closeRegBtn);
parcelHelpers.export(exports, "closeResultBtn", ()=>closeResultBtn);
parcelHelpers.export(exports, "modalAuth", ()=>modalAuth);
parcelHelpers.export(exports, "clickBox", ()=>clickBox);
parcelHelpers.export(exports, "inputChangeTheme", ()=>inputChangeTheme);
parcelHelpers.export(exports, "headerLibrary", ()=>headerLibrary);
parcelHelpers.export(exports, "notifyRef", ()=>notifyRef);
...
},{}],"fybPx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchSearchFilm", ()=>fetchSearchFilm);
parcelHelpers.export(exports, "fetchGenre", ()=>fetchGenre);
parcelHelpers.export(exports, "fetchPopularFilm", ()=>fetchPopularFilm);
parcelHelpers.export(exports, "fetchMovie", ()=>fetchMovie);
parcelHelpers.export(exports, "fetchTrailerFilm", ()=>fetchTrailerFilm);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _api = require("./api");
async function fetchPopularFilm(currentPage = 1) {
    try {
        const { data  } = await (0, _axiosDefault.default).get(`${(0, _api.BASE_URL)}/${(0, _api.discover_point)}?api_key=${(0, _api.API_KEY)}&page=${currentPage}&sort_by=popularity.desc`);
        return data;
    } catch (error) {
        console.log(error);
    }
...
async function fetchSearchFilm(query, currentPage = 1) {
    try {
        const { data  } = await (0, _axiosDefault.default).get(`${(0, _api.BASE_URL)}/${(0, _api.search_point)}?api_key=${(0, _api.API_KEY)}&page=${currentPage}&query=${query}`);
        return data;
    } catch (error) {
        console.log(error);
    }
...
async function fetchGenre() {
    try {
        const response = await (0, _axiosDefault.default).get(`${(0, _api.BASE_URL)}/${(0, _api.genre_point)}?api_key=${(0, _api.API_KEY)}`);
...
async function fetchMovie(id) {
    try {
        const response = await (0, _axiosDefault.default).get(`${(0, _api.BASE_URL)}/movie/${id}?api_key=${(0, _api.API_KEY)}`);
...
async function fetchTrailerFilm(id) {
    try {
        const response = await (0, _axiosDefault.default).get(`${(0, _api.BASE_URL)}/${(0, _api.trailer_point)}/${id}/videos?api_key=${(0, _api.API_KEY)}`);
        return response.data;
    } catch (error) {
        console.log(error);
    }
...
},{"axios":"jo6P5","./api":"kcudQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./../utils.js":"5By4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kcudQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "BASE_URL", ()=>BASE_URL);
parcelHelpers.export(exports, "API_KEY", ()=>API_KEY);
parcelHelpers.export(exports, "discover_point", ()=>discover_point);
parcelHelpers.export(exports, "genre_point", ()=>genre_point);
parcelHelpers.export(exports, "search_point", ()=>search_point);
parcelHelpers.export(exports, "trailer_point", ()=>trailer_point);
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "markupPopularFilms", ()=>markupPopularFilms);
parcelHelpers.export(exports, "render", ()=>render);
parcelHelpers.export(exports, "findGenres", ()=>findGenres);
var _fetch = require("./fetch");
var _renderFilmList = require("./renderFilmList");
...
async function markupPopularFilms() {
    if (!localStorage.getItem("genres")) await (0, _fetch.fetchGenre)();
    const response = await (0, _fetch.fetchPopularFilm)(1);
    const { results , total_pages  } = response;
    render(results);
    const instance_1 = new (0, _tuiPaginationDefault.default)((0, _refs.container), {
        ...
        template: {
            ...
            moreButton: '<a href="#" class="tui-page-btn tui-{{type}}-is-ellip"><span class="tui-ico-ellip dots">...</span></a>'
        }
    });
    instance_1.on("afterMove", async (event)=>{
        let currentPage = event.page;
        const { results  } = await (0, _fetch.fetchPopularFilm)(currentPage);
        render(results);
        window.scrollTo({
            top: 0,
            behavior: "smooth"
...
function render(results) {
    const markup = results.map(({ poster_path , backdrop_path , original_title , title , genre_ids , release_date , vote_average , id  })=>(0, _renderFilmList.prepareGalleryInfo)(poster_path, backdrop_path, original_title, title, genre_ids, release_date, vote_average, id, findGenres)).join("");
    (0, _refs.galleryRef).innerHTML = markup;
}
function findGenres(genre_ids) {
    try {
        const genresObj = JSON.parse(localStorage.getItem("genres"));
        const { genres  } = genresObj;
        return genres.filter(({ id  })=>genre_ids.includes(id)).map(({ name  })=>name || "No genres");
    } catch (error) {
        console.log(error);
    }
}

},{"./fetch":"fybPx","./renderFilmList":"jySTB","tui-pagination":"b80gR","notiflix/build/notiflix-loading-aio":"3mnqg","./refs":"jHtzO","tui-pagination/dist/tui-pagination.css":"82Il4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jySTB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "prepareGalleryInfo", ()=>prepareGalleryInfo);
var _notiflix = require("notiflix");
const noImageUrl = new URL(require("2bd8dfe5ccaba836"));
function prepareGalleryInfo(poster_path, backdrop_path, original_title, title, genre_ids, release_date, vote_average, id, findGenres) {
    // Loading.arrows();
    const hiddenClass = window.location.pathname === "/index.html" ? "visually-hidden" : "";
    const genreaMarkup = findGenres(genre_ids).join(", ");
    const poster = `https://image.tmdb.org/t/p/original${poster_path || backdrop_path}`;
    return `<li class="gallery-card" data-modal-open data-id="${id}">
      <img class = "poster"
        src= ${poster_path || backdrop_path !== undefined && poster_path || backdrop_path !== null ? poster : noImageUrl.pathname}
        alt="poster to film ${original_title}"
      />
      <div class ="gallery_info">
        <span  class ="gallery_info-title">${title.toUpperCase()}</span>
        <span class ="gallery_info-genres">${genreaMarkup.length === 0 ? "Genre not specified" : genreaMarkup}
        </span>
        <span class ="gallery_info-year">${release_date !== "" ? new Date(release_date).getFullYear() : "Year not specified"}</span>
        <span class="gallery_info-rating ${hiddenClass}">${vote_average.toFixed(1)}</span>
      </div>
     </li>`;
}

},{"notiflix":"5WWYd","2bd8dfe5ccaba836":"5k2fq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5k2fq":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("5isLt") + "default_img.6c5fa253.jpg" + "?" + Date.now();
...
},{}],"b80gR":[function(require,module,exports) {
/*!
 * TOAST UI Pagination
 * @version 3.4.1
...
},{}],"3mnqg":[function(require,module,exports) {
var global = arguments[3];
/*
...
},{}],"82Il4":[function() {},{}]},["dxiIb"], null, "parcelRequired76b")

//# sourceMappingURL=index.1cfb2be5.js.map

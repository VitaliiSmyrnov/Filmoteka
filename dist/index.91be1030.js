...
})({"iRvqq":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "c0cdf1a591be1030";
"use strict";
...
if (0, _refs.headerLibrary) (0, _refs.headerLibrary).addEventListener("click", (e)=>{
    if (!auth.currentUser) {
        e.preventDefault();
        (0, _notiflixDefault.default).Notify.warning("Please log in or register to get access to your library");
    }
});
(0, _refs.openModalAuth).addEventListener("click", toggleModal);
(0, _refs.closeLoginBtn).addEventListener("click", toggleModal);
(0, _refs.closeRegBtn).addEventListener("click", toggleModal);
(0, _refs.closeResultBtn).addEventListener("click", toggleModal);
function toggleModal() {
    (0, _refs.modalAuth).classList.toggle("is-hidden");
...
(0, _auth.onAuthStateChanged)(auth, (user)=>{
    if (auth.currentUser !== null) {
        (0, _refs.openModalAuth).style.display = "none";
        ...
        (0, _refs.openModalAuth).style.display = "inline";
...
document.getElementById("login-btn").addEventListener("click", function() {
    ...
    (0, _auth.signInWithEmailAndPassword)(auth, loginEmail, loginPassword).then((userCredential)=>{
        ...
        document.getElementById("result-box").style.display = "inline";
        document.getElementById("login-div").style.display = "none";
        document.getElementById("result").innerHTML = "Something went wrong.<br>Please check your email or password.";
...
document.getElementById("register-btn").addEventListener("click", function() {
    ...
    (0, _auth.createUserWithEmailAndPassword)(auth, registerEmail, registerPassword).then((userCredential)=>{
        const user = userCredential.user;
        document.getElementById("result-box").style.display = "inline";
        document.getElementById("register-div").style.display = "none";
        document.getElementById("result").innerHTML = "Successful registration!";
        document.getElementById("result").style.textAlign = "center";
    }).catch((error)=>{
        const errorCode = error.code;
        const errorMessage = error.message;
        document.getElementById("result-box").style.display = "inline";
        document.getElementById("register-div").style.display = "none";
        document.getElementById("result").innerHTML = "Oops! <br> Something went wrong!<br>Check your email or password please.";
        document.getElementById("result-box").style.textAlign = "center";
    });
});
document.getElementById("log-out-btn").addEventListener("click", function() {
    (0, _auth.signOut)(auth).then(()=>{
        ...
        document.getElementById("result").innerHTML = "Sorry! <br> Something is wrong.<br>";
        document.getElementById("result").style.textAlign = "center";
    });
});

},{"./refs":"jHtzO","firebase/app":"5wGMN","firebase/auth":"drt1f","notiflix":"5WWYd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5wGMN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ActionCodeOperation", ()=>(0, _index0Bb4Da3BJs.A));
parcelHelpers.export(exports, "ActionCodeURL", ()=>(0, _index0Bb4Da3BJs.ad));
parcelHelpers.export(exports, "AuthCredential", ()=>(0, _index0Bb4Da3BJs.H));
parcelHelpers.export(exports, "AuthErrorCodes", ()=>(0, _index0Bb4Da3BJs.D));
parcelHelpers.export(exports, "EmailAuthCredential", ()=>(0, _index0Bb4Da3BJs.I));
parcelHelpers.export(exports, "EmailAuthProvider", ()=>(0, _index0Bb4Da3BJs.M));
parcelHelpers.export(exports, "FacebookAuthProvider", ()=>(0, _index0Bb4Da3BJs.N));
parcelHelpers.export(exports, "FactorId", ()=>(0, _index0Bb4Da3BJs.F));
parcelHelpers.export(exports, "GithubAuthProvider", ()=>(0, _index0Bb4Da3BJs.T));
parcelHelpers.export(exports, "GoogleAuthProvider", ()=>(0, _index0Bb4Da3BJs.Q));
parcelHelpers.export(exports, "OAuthCredential", ()=>(0, _index0Bb4Da3BJs.J));
parcelHelpers.export(exports, "OAuthProvider", ()=>(0, _index0Bb4Da3BJs.U));
parcelHelpers.export(exports, "OperationType", ()=>(0, _index0Bb4Da3BJs.O));
parcelHelpers.export(exports, "PhoneAuthCredential", ()=>(0, _index0Bb4Da3BJs.K));
parcelHelpers.export(exports, "PhoneAuthProvider", ()=>(0, _index0Bb4Da3BJs.P));
parcelHelpers.export(exports, "PhoneMultiFactorGenerator", ()=>(0, _index0Bb4Da3BJs.m));
parcelHelpers.export(exports, "ProviderId", ()=>(0, _index0Bb4Da3BJs.o));
parcelHelpers.export(exports, "RecaptchaVerifier", ()=>(0, _index0Bb4Da3BJs.R));
parcelHelpers.export(exports, "SAMLAuthProvider", ()=>(0, _index0Bb4Da3BJs.V));
parcelHelpers.export(exports, "SignInMethod", ()=>(0, _index0Bb4Da3BJs.S));
parcelHelpers.export(exports, "TwitterAuthProvider", ()=>(0, _index0Bb4Da3BJs.W));
parcelHelpers.export(exports, "applyActionCode", ()=>(0, _index0Bb4Da3BJs.a2));
parcelHelpers.export(exports, "beforeAuthStateChanged", ()=>(0, _index0Bb4Da3BJs.t));
parcelHelpers.export(exports, "browserLocalPersistence", ()=>(0, _index0Bb4Da3BJs.b));
parcelHelpers.export(exports, "browserPopupRedirectResolver", ()=>(0, _index0Bb4Da3BJs.k));
parcelHelpers.export(exports, "browserSessionPersistence", ()=>(0, _index0Bb4Da3BJs.a));
parcelHelpers.export(exports, "checkActionCode", ()=>(0, _index0Bb4Da3BJs.a3));
parcelHelpers.export(exports, "confirmPasswordReset", ()=>(0, _index0Bb4Da3BJs.a1));
parcelHelpers.export(exports, "connectAuthEmulator", ()=>(0, _index0Bb4Da3BJs.G));
parcelHelpers.export(exports, "createUserWithEmailAndPassword", ()=>(0, _index0Bb4Da3BJs.a5));
parcelHelpers.export(exports, "debugErrorMap", ()=>(0, _index0Bb4Da3BJs.B));
parcelHelpers.export(exports, "deleteUser", ()=>(0, _index0Bb4Da3BJs.z));
parcelHelpers.export(exports, "fetchSignInMethodsForEmail", ()=>(0, _index0Bb4Da3BJs.aa));
parcelHelpers.export(exports, "getAdditionalUserInfo", ()=>(0, _index0Bb4Da3BJs.al));
parcelHelpers.export(exports, "getAuth", ()=>(0, _index0Bb4Da3BJs.n));
parcelHelpers.export(exports, "getIdToken", ()=>(0, _index0Bb4Da3BJs.ai));
parcelHelpers.export(exports, "getIdTokenResult", ()=>(0, _index0Bb4Da3BJs.aj));
parcelHelpers.export(exports, "getMultiFactorResolver", ()=>(0, _index0Bb4Da3BJs.an));
parcelHelpers.export(exports, "getRedirectResult", ()=>(0, _index0Bb4Da3BJs.j));
parcelHelpers.export(exports, "inMemoryPersistence", ()=>(0, _index0Bb4Da3BJs.L));
parcelHelpers.export(exports, "indexedDBLocalPersistence", ()=>(0, _index0Bb4Da3BJs.i));
parcelHelpers.export(exports, "initializeAuth", ()=>(0, _index0Bb4Da3BJs.E));
parcelHelpers.export(exports, "isSignInWithEmailLink", ()=>(0, _index0Bb4Da3BJs.a8));
parcelHelpers.export(exports, "linkWithCredential", ()=>(0, _index0Bb4Da3BJs.Z));
parcelHelpers.export(exports, "linkWithPhoneNumber", ()=>(0, _index0Bb4Da3BJs.l));
parcelHelpers.export(exports, "linkWithPopup", ()=>(0, _index0Bb4Da3BJs.d));
parcelHelpers.export(exports, "linkWithRedirect", ()=>(0, _index0Bb4Da3BJs.g));
parcelHelpers.export(exports, "multiFactor", ()=>(0, _index0Bb4Da3BJs.ao));
parcelHelpers.export(exports, "onAuthStateChanged", ()=>(0, _index0Bb4Da3BJs.v));
parcelHelpers.export(exports, "onIdTokenChanged", ()=>(0, _index0Bb4Da3BJs.q));
parcelHelpers.export(exports, "parseActionCodeURL", ()=>(0, _index0Bb4Da3BJs.ae));
parcelHelpers.export(exports, "prodErrorMap", ()=>(0, _index0Bb4Da3BJs.C));
parcelHelpers.export(exports, "reauthenticateWithCredential", ()=>(0, _index0Bb4Da3BJs._));
parcelHelpers.export(exports, "reauthenticateWithPhoneNumber", ()=>(0, _index0Bb4Da3BJs.r));
parcelHelpers.export(exports, "reauthenticateWithPopup", ()=>(0, _index0Bb4Da3BJs.e));
parcelHelpers.export(exports, "reauthenticateWithRedirect", ()=>(0, _index0Bb4Da3BJs.h));
parcelHelpers.export(exports, "reload", ()=>(0, _index0Bb4Da3BJs.am));
parcelHelpers.export(exports, "sendEmailVerification", ()=>(0, _index0Bb4Da3BJs.ab));
parcelHelpers.export(exports, "sendPasswordResetEmail", ()=>(0, _index0Bb4Da3BJs.a0));
parcelHelpers.export(exports, "sendSignInLinkToEmail", ()=>(0, _index0Bb4Da3BJs.a7));
parcelHelpers.export(exports, "setPersistence", ()=>(0, _index0Bb4Da3BJs.p));
parcelHelpers.export(exports, "signInAnonymously", ()=>(0, _index0Bb4Da3BJs.X));
parcelHelpers.export(exports, "signInWithCredential", ()=>(0, _index0Bb4Da3BJs.Y));
parcelHelpers.export(exports, "signInWithCustomToken", ()=>(0, _index0Bb4Da3BJs.$));
parcelHelpers.export(exports, "signInWithEmailAndPassword", ()=>(0, _index0Bb4Da3BJs.a6));
parcelHelpers.export(exports, "signInWithEmailLink", ()=>(0, _index0Bb4Da3BJs.a9));
parcelHelpers.export(exports, "signInWithPhoneNumber", ()=>(0, _index0Bb4Da3BJs.s));
parcelHelpers.export(exports, "signInWithPopup", ()=>(0, _index0Bb4Da3BJs.c));
parcelHelpers.export(exports, "signInWithRedirect", ()=>(0, _index0Bb4Da3BJs.f));
parcelHelpers.export(exports, "signOut", ()=>(0, _index0Bb4Da3BJs.y));
parcelHelpers.export(exports, "unlink", ()=>(0, _index0Bb4Da3BJs.ak));
parcelHelpers.export(exports, "updateCurrentUser", ()=>(0, _index0Bb4Da3BJs.x));
parcelHelpers.export(exports, "updateEmail", ()=>(0, _index0Bb4Da3BJs.ag));
parcelHelpers.export(exports, "updatePassword", ()=>(0, _index0Bb4Da3BJs.ah));
parcelHelpers.export(exports, "updatePhoneNumber", ()=>(0, _index0Bb4Da3BJs.u));
parcelHelpers.export(exports, "updateProfile", ()=>(0, _index0Bb4Da3BJs.af));
parcelHelpers.export(exports, "useDeviceLanguage", ()=>(0, _index0Bb4Da3BJs.w));
parcelHelpers.export(exports, "verifyBeforeUpdateEmail", ()=>(0, _index0Bb4Da3BJs.ac));
parcelHelpers.export(exports, "verifyPasswordResetCode", ()=>(0, _index0Bb4Da3BJs.a4));
var _index0Bb4Da3BJs = require("./index-0bb4da3b.js");
var _util = require("@firebase/util");
var _app = require("@firebase/app");
var _logger = require("@firebase/logger");
...
},{"./index-0bb4da3b.js":"dntW2","@firebase/util":"ePiK6","@firebase/app":"3AcPV","@firebase/logger":"fZmft","tslib":"lRdW5","@firebase/component":"bi1VB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dntW2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@firebase/util":"ePiK6","@firebase/app":"3AcPV","@firebase/logger":"fZmft","tslib":"lRdW5","@firebase/component":"bi1VB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lRdW5":[function(require,module,exports) {
/******************************************************************************
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["iRvqq","9GWoQ"], "9GWoQ", "parcelRequired76b")

//# sourceMappingURL=index.91be1030.js.map
